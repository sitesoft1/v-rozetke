...
dvbusiness.orderForm = new (function () {
    this.errorTranslations = {
        invalid_parameters          : 'Неправильно заполнены поля',
        unapproved_contract         : 'Ваш договор присоединения ещё не одобрен',
        buyout_not_allowed          : 'Для вашего аккаунта не доступна функция выкупа',
        insufficient_balance        : 'Недостаточно средств на балансе',
        buyout_amount_limit_exceeded: 'Сумма выкупа по активным заказам слишком велика',
        requests_limit_exceeded     : 'Превышено максимально допустимое число запросов к API'
    };

    this.parameterErrorTranslations = {
        required                   : 'Поле обязательно для заполнения',
        invalid_value              : 'Некорректное значение поля',
        min_length                 : 'Значение должно быть длиннее',
        max_length                 : 'Значение должно быть короче',
        ...
        different_regions          : 'Адреса в разных регионах не допускаются',
        invalid_region             : 'Не удалось определить регион',
        address_not_found          : 'Адрес не найден',
        min_date                   : 'Необходимо указать более позднее время',
        max_date                   : 'Необходимо указать более раннее время',
        cannot_be_past             : 'Время не может быть в прошлом',
        start_after_end            : 'Время "c" должно быть раньше времени "до"',
        earlier_than_previous_point: 'Дата доставки не может быть раньше, чем на предыдущих точках'
    };

    this.translations = {
        calculation_error: 'Не удается рассчитать заказ с такими параметрами',
        creation_error   : 'Не удалось создать заказ в Dostavista. Проверьте правильность заполнения всех полей и попробуйте еще раз.',
        validation_error : 'Неправильно заполнены поля',
        creation_success : 'Заказ #{id} на доставку успешно создан в Dostavista'
    };
});
