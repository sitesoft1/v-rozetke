<?php
$_['module_name'] = 'CSV Price Pro import/export OC3';
...
$_['text_show_help_note'] = 'Для отримання довідки натисніть на іконку <i class="f-icon-helper fa fa-info-circle fa-lg" aria-hidden="true" title=""></i>';
